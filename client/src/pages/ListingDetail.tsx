...
export default function ListingDetail() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 p-6 bg-[#F0F7FF] min-h-screen">
      <Card className="overflow-hidden border border-[#D89EAA] shadow-xl">
        <CardHeader className="bg-[#D89EAA] text-white p-6">
        ...
        <CardContent className="p-6 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-[#D89EAA]">Информация за любимеца</h2>
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <Calendar className="h-5 w-5 text-[#D89EAA]" />
                  <span>
                    Възраст:
                ...
                <div className="flex items-center gap-2">
                  <MapPin className="h-5 w-5 text-[#D89EAA]" />
            ...
            {ownerDetails && (
              <div className="space-y-4">
                <h2 className="text-2xl font-semibold text-[#D89EAA]">Информация за стопанина</h2>
                <div>
                  <Link href={`/user/${listing.userId}`}>
                    <Card className="hover:shadow-lg transition-shadow cursor-pointer">
                      <CardContent className="p-4">
                        <div className="flex items-center gap-4">
                          <div className="w-16 h-16 rounded-full bg-[#D89EAA] text-white flex items-center justify-center text-2xl font-bold">
          ...
          <div className="border-t border-gray-200 pt-6">
            <h2 className="text-2xl font-semibold text-[#D89EAA] mb-4">Описание</h2>
