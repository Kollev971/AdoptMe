...
export default function Home() {
  ...
  const MainContent = () => (
    <div 
      className="bg-cover bg-top bg-no-repeat min-h-screen absolute inset-0 top-16"
      style={{ 
        ...
        <>
          ...
          <div className="absolute bottom-16 left-1/2 transform -translate-x-1/2">
            <Link href="/auth">
              <Button 
                size="lg" 
                className="px-8 py-3 text-base rounded-full shadow-lg hover:scale-105 transition bg-[#FFD43B] hover:bg-[#FFD43B]/90 text-black"
              >
                Вход / Регистрация
              </Button>
            </Link>
